...
export default function addLocaleChinese(locales) {
    var zh_TW = {
        ...
        "alias": {
            ...
            "filter-type-device-type-and-name-description": "類型為 '{{deviceType}}' 且以 '{{prefix}}' 為開頭的設備",
        ...
        "asset": {
            ...
            "view-assets": "檢視全部資產",
            "add": "新增資產",
            "assign-to-customer": "指派給客户",
            "assign-asset-to-customer": "將資產指派給客户",
            "assign-asset-to-customer-text": "請選擇要指派給客户的資產",
            "no-assets-text": "未找到資產",
            "assign-to-customer-text": "請選擇客户以指派資產",
            "public": "公開",
            "assignedToCustomer": "指派客户",
            "make-public": "將資產設為公開",
            "make-private": "將資產設為私人",
            "unassign-from-customer": "取消已指派的客户",
            "delete": "刪除資產",
            "asset-public": "資產公開",
            "asset-type": "資產類型",
            ...
            "asset-details": "資產明細",
            "assign-assets": "指派資產",
            "assign-assets-text": "指派 { count, select, 1 {1 ; 資產} other {# 資產} } 給客户",
            "delete-assets": "删除資產",
            "unassign-assets": "取消指派資產",
            "unassign-assets-action-title": "客户处取消分配 { count, select, 1 {1 資產} other {# assets} } ",
